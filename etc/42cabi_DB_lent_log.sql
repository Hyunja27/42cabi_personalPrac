...
CREATE TABLE `lent_log` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `cabinet_id_idx` (`log_cabinet_id`),
  KEY `user_id_idx` (`log_user_id`),
  CONSTRAINT `log_cabinet_id` FOREIGN KEY (`log_cabinet_id`) REFERENCES `cabinet` (`cabinet_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `log_user_id` FOREIGN KEY (`log_user_id`) REFERENCES `user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
